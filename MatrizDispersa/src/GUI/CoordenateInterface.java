 ...
 */
public class CoordenateInterface extends javax.swing.JFrame {
    private boolean stateMatriz=false;
    private GestionDeArchivos objGestion;
    private Coordenado objCoordenado;
    
    public CoordenateInterface() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonSumMatriz = new javax.swing.JButton();
        ...
        jLabelTitle.setText("FORMATO COORDENADO");
        jLabelTitle.setToolTipText("");
        getContentPane().add(jLabelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, -1));

        jButtonSumMatriz.setBackground(new java.awt.Color(0, 0, 102));
        jButtonSumMatriz.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jButtonSumMatriz.setForeground(new java.awt.Color(255, 102, 0));
        jButtonSumMatriz.setText("SUMA DE MATRICES");
        jButtonSumMatriz.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonSumMatrizActionPerformed(evt);
            }
        });
        getContentPane().add(jButtonSumMatriz, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 300, 220, -1));
        ...
        getContentPane().add(jButtonSetPosicion, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, 220, -1));
        ...
        getContentPane().add(jButtonGetColumn, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 250, 220, -1));
        ...
        getContentPane().add(jButtonGetRow, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 200, 220, -1));
    ...
    private void jButtonFormatoCoordenadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFormatoCoordenadoActionPerformed
            ...
            try {
                stateMatriz=true;
                objCoordenado.loadMatriz(objGestion.getMatriz(),objGestion.getFilas(),objGestion.getColumnas());
                objCoordenado.coordinateFormat();
    ...
    private void jButtonGetRepresentationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetRepresentationActionPerformed
        objCoordenado.coordinateFormat();
        objCoordenado.createFileRepresentation(objGestion.getRoute());
    ...
    private void jButtonGetMatrizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetMatrizActionPerformed
        objCoordenado.coordinateFormat();
        objCoordenado.createFileMatriz(objGestion.getRoute());
    ...
    private void jButtonGetElementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetElementActionPerformed
        ...
        try {
            objCoordenado.coordinateFormat();
            objCoordenado.getElement(Integer.parseInt(fila),Integer.parseInt(columna));
    ...
    private void jButtonGetRowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetRowActionPerformed
        ...
        objCoordenado.coordinateFormat();
        objCoordenado.getRow(Integer.parseInt(fila));
    ...
    private void jButtonGetColumnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGetColumnActionPerformed
        ...
        objCoordenado.coordinateFormat();
        objCoordenado.getColumn(Integer.parseInt(columna));
    ...
    private void jButtonSetPosicionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSetPosicionActionPerformed
            ...
            try {
                objCoordenado.coordinateFormat();
                objCoordenado.setPosition(objGestion.getRoute(),Integer.parseInt(fila),Integer.parseInt(columna),Integer.parseInt(numero));
            } catch (IOException ex) {
                Logger.getLogger(CoordenateInterface.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButtonSquareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSquareActionPerformed
        objCoordenado.coordinateFormat();
        objCoordenado.squareMatriz(objGestion.getRoute());
    ...
    private void jButtonTransposeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTransposeActionPerformed
        objCoordenado.coordinateFormat();
        objCoordenado.transposedMatriz(objGestion.getRoute());
    }//GEN-LAST:event_jButtonTransposeActionPerformed

    private void jButtonSumMatrizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSumMatrizActionPerformed
            ...
            try {
                stateMatriz=true;
                objCoordenado.loadMatrizSum(objGestion.getMatriz(),objGestion.getFilas(),objGestion.getColumnas());
                objCoordenado.coordinateFormatSum();
                objCoordenado.sumMatrices(objGestion.getRoute());

            } catch (FileNotFoundException ex) {
                Logger.getLogger(CoordenateInterface.class.getName()).log(Level.SEVERE, null, ex);
            }

    }//GEN-LAST:event_jButtonSumMatrizActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoordenateInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoordenateInterface().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButtonSumMatriz;
